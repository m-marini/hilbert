...
\begin{equation*}
	P_f = \eta(T) Q_r = \eta(T) \min(N_f \pi_f, \beta_f R) \Delta t
\end{equation*}
...
Per definire la distribuzione della popolazione ipotizziamo un gruppo iniziale di 2 famiglie tipo: 2 adulti che devono mantenere 4 figli e 4 genitori.
La popolazione totale è di 20 individui della quale quella produttiva è di 4 individui.
Dei 4 produttivi poniamo che 2 producono cibo, un ricercatore e un educatore.
...
\begin{align*}
	R_f \ge \max \left(20 \frac{1}{0.01}, 10000 \right)
	\\
	R_f \ge 10000
\end{align*}
...
\begin{align*}
	f_{ri}(T_0) = 0.1
	\\
	\pi_r = 0.1 \frac{1}{20 \cdot 0.01 \cdot 0.05} = 10
\end{align*}
...
\begin{align*}
	R_e \ge \max \left( \frac{20}{0.01}, 10000 \right)
	\\
	R_e \ge 10000
\end{align*}
